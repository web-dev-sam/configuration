...
export const update: ConfigurationPlugin["update"] = () => {
    ...
    fs.writeFileSync(__dirname + "/javascript.jsonc", fs.readFileSync(jsFile, "utf-8"), "utf-8");
    fs.writeFileSync(__dirname + "/typescript.jsonc", fs.readFileSync(tsFile, "utf-8"), "utf-8");
};
